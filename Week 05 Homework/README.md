...
Your objective is to build a [BubblePlot](https://en.wikipedia.org/wiki/Bubble_chart) that showcases the relationship between four key variables:

* Average Fare ($) Per City --> 		y-axis
* Total Number of Rides Per City --> 	bubble size
* Total Number of Drivers Per City --> 	x-axis
